      ...
      <div className="container mx-auto px-4 lg:px-8 relative">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mt-4 mb-6">
            Book Your{" "}
            <span className="text-gradient-blue">Appointment</span>
          </h2>
        ...
        <div className="max-w-3xl mx-auto">
          {/* Main CTA */}
          <div className="bg-card border border-border rounded-3xl p-8 lg:p-12 text-center mb-8 shadow-soft">
            ...
            <a href="tel:+917738943718">
              <Button variant="hero" size="xl" className="text-xl px-10 py-6 h-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-start gap-5 p-6 bg-card border border-border rounded-2xl shadow-soft">
            ...
            <div className="flex items-start gap-5 p-6 bg-card border border-border rounded-2xl shadow-soft">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Sunday: 10 AM – 2 PM</p>
              </div>
            </div>
          </div>

          {/* Google Maps Embed */}
          <div className="mt-8 bg-card border border-border rounded-2xl overflow-hidden shadow-soft">
            <iframe
